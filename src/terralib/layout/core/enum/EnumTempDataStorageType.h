...
#ifndef __TERRALIB_LAYOUT_INTERNAL_ENUM_TEMP_DATASTORAGE_TYPE_H 
#define __TERRALIB_LAYOUT_INTERNAL_ENUM_TEMP_DATASTORAGE_TYPE_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT EnumTempDataStorageType : public AbstractEnum
    {
      public:
        ...
        /*!
          \brief Constructor
        */
        EnumTempDataStorageType();

        /*!
          \brief Destructor
        */ 
        virtual ~EnumTempDataStorageType();
        ...
        /*!
          ...
          \return enum value      
        */
        virtual EnumType* getTempFileType() const;
      ...
      protected:
        ...
        EnumType* m_tempFileType; //!< value that represents temp file type belonging to enumeration
    };
  }
}
