...
{
  int version = te::layout::Version::asInt();
  std::string versionCaption = te::layout::Version::asString();
  ...
  rootNode.add("version", version);
  rootNode.add("version_caption", versionCaption);
...
{
  //here we get the version number
  int version = tree.get<int>("template.version", 0x010000);
  int currentVersion = te::layout::Version::asInt();

  if (version > currentVersion)
  {
    throw te::common::Exception(TE_TR("The given Map could not be read. It was generated by a more recent version of TerraPrint. You must upgrade TerraPrint to be able to open the given Map!"));
  }
...
std::string te::layout::BoostPropertySerializer::toUTF8(const std::string& latin1String) const
{
  ...
  std::string utf8_string = te::core::CharEncoding::toUTF8(latin1String, te::core::EncodingType::LATIN1);
  return utf8_string;
}
...
std::string te::layout::BoostPropertySerializer::fromUTF8(const std::string& utf8String) const
{
  ...
  std::string latin1_string = te::core::CharEncoding::fromUTF8(utf8String, te::core::EncodingType::LATIN1);
