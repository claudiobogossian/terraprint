...
te::layout::DoubleSpinBoxRender::DoubleSpinBoxRender()
{
...
void te::layout::DoubleSpinBoxRender::render(QPainter * painter, const QStyleOptionViewItem & option, const QModelIndex & index)
{
