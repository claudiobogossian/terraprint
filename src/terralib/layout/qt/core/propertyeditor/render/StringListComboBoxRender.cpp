...
// TerraLib
#include "StringListComboBoxRender.h"
...
te::layout::StringListComboBoxRender::StringListComboBoxRender()
{
...
void te::layout::StringListComboBoxRender::render(QPainter * painter, const QStyleOptionViewItem & option, const QModelIndex & index)
{
