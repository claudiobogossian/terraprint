...
#ifndef __TERRALIB_LAYOUT_INTERNAL_STRINGLINE_EDITOR_H 
#define __TERRALIB_LAYOUT_INTERNAL_STRINGLINE_EDITOR_H
...
namespace te
{
  namespace layout
  {
    ...
    \ingroup layout
    */
    class TELAYOUTEXPORT StringLineEditor : public QLineEdit, public AbstractEditor
    {
