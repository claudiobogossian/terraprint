...
/*!
  \file terralib/layout/qt/core/pattern/factory/render/StringListComboBoxRenderFactory.h

  \brief This is the concrete factory for create renders.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_STRINGLIST_COMBOBOX_RENDER_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_STRINGLIST_COMBOBOX_RENDER_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT StringListComboBoxRenderFactory : public RenderFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        StringListComboBoxRenderFactory();
