...
/*!
  \file terralib/layout/qt/core/pattern/factory/outside/MapSettingsOutsideFactory.h

  \brief This is the concrete factory for color dialog outside.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_MAP_SETTINGS_OUTSIDE_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_MAP_SETTINGS_OUTSIDE_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    /*!
      \class MapSettingsOutsideFactory

      \brief This is the concrete factory for color dialog outside.

      \sa NewOutsideFactory, ParameterizedAbstractFactory, AbstractOutsideView
    */
    class TELAYOUTEXPORT MapSettingsOutsideFactory : public OutsideFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        MapSettingsOutsideFactory();
