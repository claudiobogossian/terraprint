...
/*!
  \file terralib/layout/qt/core/pattern/factory/outside/MapLocationSettingsOutsideFactory.h

  \brief This is the concrete factory for color dialog outside.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_MAP_LOCATION_SETTINGS_OUTSIDE_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_MAP_LOCATION_SETTINGS_OUTSIDE_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT MapLocationSettingsOutsideFactory : public OutsideFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        MapLocationSettingsOutsideFactory();
