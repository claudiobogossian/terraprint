...
/*!
  \file terralib/layout/qt/core/pattern/factory/outside/ScaleSettingsOutsideFactory.h

  \brief This is the concrete factory for color dialog outside.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_SCALE_SETTINGS_OUTSIDE_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_SCALE_SETTINGS_OUTSIDE_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT ScaleSettingsOutsideFactory : public OutsideFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        ScaleSettingsOutsideFactory();
