...
/*!
  \file terralib/layout/qt/core/pattern/factory/render/DoubleSpinBoxRenderFactory.h

  \brief This is the concrete factory for create renders.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_DOUBLE_SPINBOX_RENDER_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_DOUBLE_SPINBOX_RENDER_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT DoubleSpinBoxRenderFactory : public RenderFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        DoubleSpinBoxRenderFactory();
