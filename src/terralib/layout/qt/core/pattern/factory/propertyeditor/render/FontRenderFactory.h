...
/*!
  \file terralib/layout/qt/core/pattern/factory/render/FontRenderFactory.h

  \brief This is the concrete factory for create renders.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_FONT_RENDER_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_FONT_RENDER_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT FontRenderFactory : public RenderFactory
    {
      public:
