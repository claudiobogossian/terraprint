...
/*!
  \file terralib/layout/qt/core/pattern/factory/render/ColorRenderFactory.h

  \brief This is the concrete factory for create renders.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_COLOR_RENDER_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_COLOR_RENDER_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT ColorRenderFactory : public RenderFactory
    {
      public:
