...
/*!
  \file terralib/layout/qt/core/pattern/factory/editor/MapSettingsEditorFactory.h

  \brief This is the concrete factory for create editors.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_MAP_SETTINGS_EDITOR_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_MAP_SETTINGS_EDITOR_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT MapSettingsEditorFactory : public EditorFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        MapSettingsEditorFactory();
