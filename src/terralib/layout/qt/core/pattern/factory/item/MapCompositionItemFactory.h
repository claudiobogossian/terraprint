...
/*!
  \file terralib/layout/qt/core/pattern/factory/MapCompositionItemFactory.h

  \brief This is the concrete factory for item group item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_MAP_COMPOSITION_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_MAP_COMPOSITION_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    /*!
      \class ItemGroupItemFactory

      \brief This is the concrete factory for item group item.

      \sa NewItemFactory, ParameterizedAbstractFactory, AbstractItemView
    */
    class TELAYOUTEXPORT MapCompositionItemFactory : public ItemFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        MapCompositionItemFactory();
